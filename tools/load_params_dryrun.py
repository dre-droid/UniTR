...
def main():
    ...
    if args.pretrained_model is not None:
        model.load_params_from_file(filename=args.pretrained_model, to_cpu=True, logger=logger)

    if args.ckpt is not None:
        it, start_epoch = model.load_params_with_optimizer(args.ckpt, to_cpu=True, optimizer=optimizer, logger=logger)
    ...
    # -----------------------start training---------------------------
    logger.info('********************** DRY RUN SUCCESSFUL: Checkpoint loaded into RAM! **********************')
    # train_model(
    #     model,
    #     optimizer,
    # ...
